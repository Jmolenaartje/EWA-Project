export class User {
    ...
    static createUser() {
        ...
        return new User(fakeRank[randomNumber], fakeUserName[randomNumber], fakePassword[randomNumber], fakeEmail[randomNumber],
            fakePhoneNumber[randomNumber], fakeCity[randomNumber],fakecountry, fakeScore[randomNumber]);
    }
